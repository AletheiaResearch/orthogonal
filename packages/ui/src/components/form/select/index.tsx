...
import { CheckIcon, ChevronDownIcon, ChevronUpIcon } from "../../primitives/icons";
...
>(({ className, children, density = "default", ...props }, ref) => (
  <SelectPrimitive.Trigger
    ref={ref}
    className={cn(
      "hover:border-foreground/20 focus-visible:ring-ring/40 border-border bg-input text-foreground focus-visible:border-ring flex w-full items-center justify-between gap-2 rounded-sm border transition focus-visible:outline-none focus-visible:ring-2 disabled:cursor-not-allowed disabled:opacity-50 [&>span]:line-clamp-1",
