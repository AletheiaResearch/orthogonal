      ...
      <ReactMarkdown
        ...
        components={{
          ...
          code: ({ className, children, ...props }: ComponentPropsWithoutRef<"code">) => {
            ...
            return (
              <code
                className="border-border bg-muted rounded border px-1.5 py-0.5 font-mono text-[0.85em]"
                {...props}
              >
                {children}
              </code>
          ...
          blockquote: ({ children, ...props }: ComponentPropsWithoutRef<"blockquote">) => (
            <blockquote
              className="border-border text-muted-foreground border-l-4 pl-4 italic"
              {...props}
            >
              {children}
            </blockquote>
          ...
          th: ({ children, ...props }: ComponentPropsWithoutRef<"th">) => (
            <th className="border-border bg-card border px-3 py-1 font-medium" {...props}>
              {children}
            </th>
          ),
