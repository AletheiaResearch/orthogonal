...
def _resolve_clone_token(repo_owner: str | None = None) -> str | None:
...
async def api_create_sandbox(
    ...
    try:
        ...
        clone_token = (
            _resolve_clone_token(request.get("repo_owner"))
...
async def api_restore_sandbox(
    ...
    try:
        ...
        manager = SandboxManager()
        clone_token = _resolve_clone_token(session_config.get("repo_owner"))
